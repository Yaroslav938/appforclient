                ...
                if "Instagram" in platforms:
                    try:
                        ...
                        for item in ig_items:
                            ...
                            # ПРОКАЧКА: Если IG скрыл просмотры в API, восстанавливаем их примерное значение через лайки (х10)
